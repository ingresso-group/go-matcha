...
type expectedXMLString struct {
	StringField string `xml:"string_field"`
}
...
//type expectedListOfObjects []ExpectedXMLComplex

//type expectedNestedListOfObjects struct {
//        Results []ExpectedXMLComplex `XML:"results"`
//}
...
//                        Convey("It should return an error string", func() {
//                                success := ShouldMatchExpectedXMLResponse(fakeXML, expected, nil)
//                                So(success, ShouldStartWith, "No field 'string_field' found in response XML")
//                        })
...
//                        fakeXML := []byte(`{"string_field": "some string", "another_field": 10}`)
...
//func TestXMLObjectMatching(t *testing.T) {

//        Convey("Given an expected nested struct", t, func() {

//                var expected ExpectedXMLComplex

//                Convey("When matches actual XML structure", func() {

//                        fakeXML := []byte(`{"result": {"attributes":{ "string_field": "fantastic"}, "success": true } }`)
...
//                        fakeXML := []byte(`{"result": false}`)

//                        Convey("It should return an error string", func() {
//                                success := ShouldMatchExpectedXMLResponse(fakeXML, expected, nil)
//                                expectedErrString := "Was expecting a XML object for field: result"
//                                So(success, ShouldStartWith, expectedErrString)
//                        })
...
//                        fakeXML := []byte(`{"string_field": "some string"}`)
...
//                        fakeXML := []byte(`{"string_field": "I've been captured!", "number_field": 16}`)
...
//                        fakeXML := []byte(`{"url": "https://www.google.com"}`)
